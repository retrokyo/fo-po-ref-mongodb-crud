...
Further the app is written assuming you have a products DB, [so make sure that you create one, and are using it in the MongoDB Service (mongo Shell Section)](https://docs.mongodb.com/v4.0/mongo/)
